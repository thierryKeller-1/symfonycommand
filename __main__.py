...
parser.add_argument('-nd', '--number-of-data',dest='number_of_data',default=50000, help='number of data')
        ...
        match(args.action):
            case 'start':
                if args.number_of_page and args.number_of_data:
                    prog.set_number_of_page(int(args.number_of_page))
                    prog.set_number_of_data(int(args.number_of_data))
                prog.create_log()
                prog.load_log()
                prog.run()
